describe('solvers', function () {
  ...
  describe('countNQueensSolutions()', function () {
    ...
    it('finds the number of valid solutions for even n of 0-12', function () {
      _.range(0, 6).map(function (n) {
        var solutionCount = countNQueensSolutions(n * 2);
        var expectedSolutionCount = [1, 0, 2, 4, 92, 724][n];
